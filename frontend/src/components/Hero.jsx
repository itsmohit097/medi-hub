  ...
  return (
    <Slider {...settings}>
      {images.map((image, index) => (
        <div key={index} className={" w-full  bg-black/20  "}>
          <div className="w-full h-[100vh] relative md:bg-left-top bg-cover bg-no-repeat bg-center" style={{ backgroundImage: `url(${image})` }}>
