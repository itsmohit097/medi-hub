...
const testimonials = [
  {
    ...
    country: "USA",
    state: "California",
    review: "On the Window talking painted pasture yet its express parties use. Sure last upon he same as knew next. Of belived or diverted no.",
  ...
  },
  {
    ...
    country: "Canada",
    state: "Ontario",
    review: "I love using Skilline, it has made healthcare so much easier.",
  ...
  const handleAssessment = async (e) => {
    ...
    try {
      await axios
        .post(
          "/testimonial/add",
          { name, profile, country, state, review, picture },
          {
            withCredentials: true,
            headers: { "Content-Type": "application/json" },
          }
